<template>
    <div class="signup">
        <header class="profile masthead-profile">
                            ...
                            <div class="card card-user">
                                <div class="row">
                                    <div class="col col-sm-4 left">
                                        ...
                                        <h4>{{user.name}}</h4>
                                        <p>Role: {{ user.name === "Shloimi" ? "admin" : "user"}}</p>
...
<style>
    .masthead-profile {
        ...
        background: linear-gradient(to bottom, rgba(92, 77, 66, 0.8) 0%, rgba(92, 77, 66, 0.8) 100%), url("../../public/img/portfolio/fullsize/13.jpg");
